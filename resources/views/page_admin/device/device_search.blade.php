          ...
          <div class="card">
            <div class="card-header">
              ...
              <h3 class="card-title">Danh sách thiết bị                
                ...
                <form class="form-inline ml-3" style="display: inline;" method="get" action="{{route('devicesearch')}}">
            ...
            <!-- search -->
            <div>
              <h5>kết quả tìm kiếm <i>'{{$Key}}'</i></h5>
                <div>
                    <p class="pull-left">Tìm thấy {{count($device) + count($deviceadmin)}}</p>
